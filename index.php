  ...
  <div class="container">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="?x=motor">Motor</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row mt-3">
      <div class="col-md-4">
        ...
        <ul class="list-group list-group-flush">
          <?Php
          $cari = mysqli_query($konek, "select * from motor where s_motor='Tersedia'");
    ...
    <div class="row mt-3">
      <div class="col-md-12 " style="background-color: #f0f0f0;">
        <b>
          <p class="text-center">Rental Motor ID&copy;2023</p>
